...
``` r
print("Входящий трафик ≈ 11.6 ГБ")
```

    [1] "Входящий трафик ≈ 11.6 ГБ"

``` r
print("Исходящий трафик ≈ 6.26 ГБ")
```

    [1] "Исходящий трафик ≈ 6.26 ГБ"
...
``` r
print("Входящий трафик ≈ 4.72 ГБ - 6.89 Гб")
```

    [1] "Входящий трафик ≈ 4.72 ГБ - 6.89 Гб"

``` r
print("Исходящий трафик ≈ 2.55 ГБ - 3.71 Гб")
```

    [1] "Исходящий трафик ≈ 2.55 ГБ - 3.71 Гб"

``` r
print("Неопознанный трафик ≈ 1.24 ГБ - 1.81 Гб")
```

    [1] "Неопознанный трафик ≈ 1.24 ГБ - 1.81 Гб"

### 4. Сделаем дашборд из ранее созданных чартов.

![](screen/11.png)

***Ссылка на дашборд:*** [Анализ сетевой
